...
/**
 * Class CoordinatorsSearchType
 *
 * @package App\Bundle\Base\Form
 */
class CoordinatorsSearchType extends AbstractType
{
    /**
     * @var array
     */
    ...
    protected function addElements(FormInterface $form, $data = [])
    {
        ...
        $form->add('search', TextType::class)
            ->add('type', ChoiceType::class, [
                'choices' => Permission::USER_COORDINATORS_ROLES,
                'placeholder' => 'Select',
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => CoordinatorsSearch::class,
            'method' => 'get',
            'csrf_protection' => false,
            'attr' => ['class' => 'row', 'novalidate' => 'novalidate', 'id' => 'coordinatorsFormSearch'],
            'edition' => null,
        ]);
    }
}
