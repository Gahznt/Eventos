...
/**
 * Class ArticleIndicationType
 *
 * @package App\Bundle\Base\Form
 */
class ArticleIndicationType extends AbstractType
{
    /**
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => ArticleIndicationSearch::class,
            'edition' => null,
            'method' => 'get',
            'csrf_protection' => false,
            'attr' => ['class' => 'row', 'novalidate' => 'novalidate', 'id' => 'articleIndicationFormSearch'],
        ]);
    }
}
