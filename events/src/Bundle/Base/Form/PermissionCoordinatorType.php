 ...
 */
class PermissionCoordinatorType extends AbstractType
{
    private $userService;
    ...
    {
        $builder
            ->add('coordinator', ChoiceType::class, [
                'placeholder' => 'Select',
                'mapped' => false,
                'required' => true,
            ])
    ...
    function onPreSubmit(FormEvent $event)
    {
        ...
        if (!isset($data['coordinator'], $data['edition'])) {
            return;
        }
        ...
        $options = [
            ...
            'query_builder' => function (EntityRepository $er) use ($data) {
                return $er->createQueryBuilder('u')
                    ->where('u.id = ' . $data['coordinator']);
            },
            'data' => $this->userService->getUserById($data['coordinator']),
            'label' => false,
            'required' => true,
            'constraints' => [
                new NotBlank(['message' => 'NotBlank.default']),
        ...
        $form->add('coordinator', EntityType::class, $options);
    ...
    public function configureOptions(OptionsResolver $resolver)
    {
        $resolver->setDefaults([
            'data_class' => DivisionCoordinator::class
        ]);
    }
}
